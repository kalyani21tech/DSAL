    ...
    do {
        ...
        switch(option) {
            ...
            case '2':
                ...
                file.clear();
                if (isFound == 0) cout << endl << "Data not found for employee ID#" << ID;
                break;
            ...
            case '3':
                ...
                file.clear();
                if (isFound == 0) cout << endl << "Data not found for department " << Dept;
                break;
            ...
            case '6':
                ...
                if (isFound == 0) {
                    ...
                    file.read((char*)&e, sizeof(e));
                    while (!file.eof()) {
                        if (e.GetID() != ID) temp.write((char*)&e, sizeof(e));
                        file.read((char*)&e, sizeof(e));
                    }
                    file.close();
                    temp.close();
